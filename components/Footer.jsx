      ...
      <div className="mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 gap-4 text-gray-700">
          <div>
            ...
            <div>
              <Link
                ...
                href="https://gdsc-abesit.vercel.app/team"
              >
                Meet the Team
              </Link>
            </div>
          ...
          <div>
            ...
            <div>
              <Link className="font-light" href="UpcomingEvents">
                Upcoming Events
              </Link>
            </div>
          </div>
          <div>
            ...
            <div>
              <Link className="font-semibold" href="/Guidelines">
          ...
          <div className="text-center sm:text-right mt-4 sm:mt-0">
            <p className="text-xs font-light">
              ...
              <span className="font-semibold">
                Google Developer Student Club, ABESIT.
              </span>
            </p>
          </div>
        </div>
